...
<div class="wrapper">
  ...
  <!-- Preloader -->
   <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{ asset('adminlte/img/logo_b.svg') }}" alt="AdminLTELogo" height="60" width="60">
  </div> 
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; {{ now()->year }} <a href="{{ route('admin.index')}}">WebReych</a>.</strong>
   Все права защищены.
...
<script src="{{ asset('scripts/admin/admin.js') }}"></script>
