...
// document.addEventListener('DOMContentLoaded', () => {
//     var colours = new Array('#ff2642', '#f0f', '#ffffff', '#f39');
//     var icons = new Array( '9675');
//     var minisize = 30;
//     var maxisize = 50;
//     var hearts = 200;
...
//                 else heart.style.opacity = 0.20;
//                 heart.appendChild(document.createTextNode(String.fromCharCode(icons[randomInteger(0, icons.length - 1)])));
...
//             for (c = 0; c < hearts; c++)
//                 if (herzy[c] === false) {
//                     herz[c].firstChild.nodeValue = String.fromCharCode(icons[randomInteger(0, icons.length - 1)]);
...
//     {
//         vivusOptions = {
//             file: '/img/contacts.svg',
//         }
//        new Vivus('contact-img', 
//        vivusOptions
//        , function (vivus) {
//         vivus.el.setAttribute('height', '600px');
  ...
  $('.post__slider').slick({
    ...
    if (projects.length > 0) {
        projects.each(function(index){
           let label = $(this).find('.project__symbol');
           let oldBg = $(this).css('background');
           $(this).hover(function(){
                $(this).css('background', label.css('background'));
           }, function(){
